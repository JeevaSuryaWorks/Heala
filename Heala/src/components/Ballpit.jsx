...
class x {
  ...
  #a;
  #c = {
    _old: performance.now(),
    start() { this._old = performance.now(); },
    stop() {},
    getDelta() {
      const now = performance.now();
      const delta = (now - this._old) / 1000;
      this._old = now;
      return delta;
    }
  };
  ...
  #p() {
    ...
    this.renderer.debug.checkShaderErrors = false; // Suppress DirectX warning logs
  }
  #g() {
